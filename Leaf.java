...
public class Leaf extends Node {
    ...
    public Map<Character, List<Boolean>> traverse(List<Boolean> list) {
    	...
    	Map<Character, List<Boolean>> map = new HashMap<>();	//putting the booleans which represent the path to a 
    		map.put(this.label, list);							//leaf and the characters into a hashMap and return that map																										*/
    		return map;
